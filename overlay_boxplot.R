# Overlay boxplot by Denis O'Hora (@denisohora)
# Based on an R script by Frank Soboczenski, PhD 
...
ggplot(iris) +
  ...
  geom_point(aes(x = as.numeric(Species), colour = Species, y = Sepal.Length),
